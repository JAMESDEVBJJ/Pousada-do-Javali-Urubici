...
const CHALES = [
  {
    ...
    tag: "A Casa de vidro",
    title: "Casa de vidro",
    text: "Pé-direito alto, muita luz natural com um teto de vidro e uma varanda voltada para floresta. Quartos, banheiro e cozinha completa em meio à natureza.",
    img: IMAGES.casas,
  ...
  },
  {
    ...
    text: "Ambientes revestidos em madeira, quarto com vista paras montanhas, banheiros privativos e cozinha bem equipada integrada a sala. Perfeito para receber a família.",
